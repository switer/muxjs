...
function Ctor(options, receiveProps) {
    ...
    function _$sync(kp, value) {
        ...
        keypath.set(_props, kp, value, function (tar, key, value) {
    ...
    function _$add(prop, value) {
        ...
        _props[prop] = _valueHook(prop, value)
